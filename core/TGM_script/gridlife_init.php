 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Autmun Theme
 ...
 *
 * Parent Theme:
 * require_once get_template_directory() . '/core/TGM_script/class-tgm-plugin-activation.php';
 */
require_once get_template_directory() . '/core/TGM_script/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'autmun_theme_register_required_plugins' );
 ...
 */
function autmun_theme_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		/**
		 * Required plugins for themes
		 *
		 * i).  Advanced custom fields.
		 * ii). WPGL gutenberg blocks.
		 * iii).
		 *
		 */
		array(
		...
		array(
			...
			'source'             => 'https://downloads.wordpress.org/plugin/jetpack.8.0.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
		...
		/**
		 * Recommended plugins for themes
		 *
		 * i).  WordPress SEO by Yoast.
		 * ii). Contact form 7.
		 * iii).
		 *
		 */
	 ...
	 */
	$config = array(
		'id'           => 'autmun_theme',                 // Unique ID for hashing notices for multiple instances of TGMPA.
