...
$categories_settings = $theme_settings['section-categories'] ? explode(",", $theme_settings['section-categories']) : '' ;
...
<section class="section c-section">
	<div class="row">
		...
		<div class="col-xs-12 col-md-9 col-lg-9 no-padding-left compact">
				...
				<div class="row">
					...
					<div class="col-xs-12 col-md-3 col-lg-3 no-padding-right">
						...
						<?php 
							...
							do_action('snow_category_var', $item);
							get_template_part( 'template-parts/sections/section', 'sidebar' ); 
